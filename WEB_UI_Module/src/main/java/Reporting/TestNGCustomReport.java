...
public class TestNGCustomReport implements IReporter {
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>Spot On Automation Report</title>");
        writeStylesheet();
        writer.print("</head>");
    }
...
//writer.print(".skippedeven td {background-color: #CCC}");
    ...
    protected void writeBody() {
        ...
        writer.print("<body>");
        writeReportTitle("Spot On  Automation Report");
        writeProjectDetails();
        writeSuiteSummary();
    ...
    protected void writeProjectDetails() {
        ...
        writer.print("<td> "+ SystemProperties.BUILD_URL+"Spot_On_5fAutomation_5fReport/" +" </td>");
        writer.print("</tr>");
