...
public interface SystemProperties {
  ...
  //  public static final String AUTOMATE_ACCESS_KEY = "kxcLz1kAScjLqRpxyPro";
    ...
    String TRAFFICKER_USERNAME = System.getProperty("TraffickerName","achin+trafficker@vtechys.com");
   ...
   // String REMOTE_URL = getProperty("remote.url", "http://54.226.11.199:4444/wd/hub");
    ...
    String PROPOSAL_NAME_AM = System.getProperty("ProposalNameAM",randomString()+" Automation");
    ...
    String SEARCH_KEY_PUBLISHERS = System.getProperty("SearchKeyPublishers",PUBLISHER_NAME);
    ...
    String campaignKey = System.getProperty("CampaignKey", rwd.readData(p));
